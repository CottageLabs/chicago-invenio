...
class CommunityAssignmentAlgorithm:
        ...
        with open(self.csv_file_path, 'r', encoding='utf-8') as f:
            ...
            for row in reader:
                ...
                if field_691:
                    ...
                    if not (field_336.strip().lower() == 'dissertation' and community == 'UChicago Dissertations'):
    ...
    def assign_communities(self, 
        ...
        if exact_match and exact_match['community'] not in all_matches['communities']:
            ...
            all_matches['details']['matched_on'].append(f"exact:{exact_match['community']}")
    ...
    def _find_exact_combination_match(self, divisions: List[str], departments: List[str], 
                                    centers: List[str], resource_type: str) -> Optional[Dict]:
    ...
    def _find_all_possible_matches(self, divisions: List[str], departments: List[str],
                                 centers: List[str], resource_type: str) -> Dict:
        ...
        if resource_type and resource_type.lower() in ['dissertation', 'publication-dissertation']:
...
def test_algorithm():
    ...
    test_cases = [
        ...
        # Case 4: Multiple departments (should find ALL)
        {
            ...
            'expected': ['Gaming Islam', 'Arts & Humanities Division']  # Should find both
        },
